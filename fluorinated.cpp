...
FCWindow::FCWindow(QWidget* parent) : QWidget(parent)
{
    ...
    chart->setTitle("Levels of Fluorinated Compounds over time");
    ...
    connect(pollutantSelector, &QComboBox::currentTextChanged, this, &FCWindow::updateCompliance);
    ...
    connect(searchBar, &QLineEdit::textChanged, this, &FCWindow::handleSearch);
    
}

void FCWindow::updateCompliance(const QString& pollutant)
{
...
void FCWindow::handleSearch(const QString& searchText)
{
